...
class _ResponsiveUserDashboardState extends State<ResponsiveUserDashboard> 
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Payment Test Button
              _buildPaymentTestButton(isMobile, isTablet),
              SizedBox(height: isMobile ? 20.0 : 32.0),
              
              // Services Integration Test Button
              _buildServicesIntegrationTestButton(isMobile, isTablet),
              SizedBox(height: isMobile ? 20.0 : 32.0),
  ...
  Widget _buildPaymentTestButton(bool isMobile, bool isTablet) {
    return Container(
      width: double.infinity,
      padding: EdgeInsets.all(isMobile ? 16.0 : 24.0),
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: isMobile ? 12.0 : 16.0),
          Text(
            'Test the real payment system with live API calls',
            style: GoogleFonts.cairo(
              fontSize: isMobile ? 14.0 : 16.0,
              color: AppColors.textSecondary,
            ),
          ...
          ElevatedButton.icon(
            onPressed: () {
              Navigator.pushNamed(context, '/debug-payment-test');
            },
            icon: Icon(Icons.science, size: isMobile ? 20.0 : 24.0),
            label: Text(
              'Test Payment System',
              style: GoogleFonts.cairo(
                fontSize: isMobile ? 14.0 : 16.0,
  ...
  Widget _buildServicesIntegrationTestButton(bool isMobile, bool isTablet) {
    return Container(
      width: double.infinity,
      padding: EdgeInsets.all(isMobile ? 16.0 : 24.0),
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: isMobile ? 12.0 : 16.0),
          Text(
            'Test the complete services API integration with CRUD operations',
            style: GoogleFonts.cairo(
              fontSize: isMobile ? 14.0 : 16.0,
              color: AppColors.textSecondary,
            ),
          ...
          ElevatedButton.icon(
            onPressed: () {
              Navigator.pushNamed(context, '/services-integration-test');
            },
            icon: Icon(Icons.api, size: isMobile ? 20.0 : 24.0),
            label: Text(
