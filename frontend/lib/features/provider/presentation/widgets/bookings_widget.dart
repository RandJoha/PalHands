...
class _BookingsWidgetState extends State<BookingsWidget> {
  ...
  final List<Map<String, dynamic>> _bookings = [
    ...
    },
    {
      ...
      'hasRating': true,
      'rating': 4.0,
      'comment': 'Great client, very cooperative and clean home.',
    },
  ];
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    if (booking['status'] == 'completed') ...[
                      Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            borderRadius: BorderRadius.circular(8),
                            onTap: () => _showRatingDialog(index, booking, languageService),
                            child: Padding(
                              padding: EdgeInsets.symmetric(
                                horizontal: isMobile ? 8.0 : (isTablet ? 10.0 : 12.0),
                                vertical: isMobile ? 6.0 : (isTablet ? 8.0 : 10.0),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    AppStrings.getString('rateClient', languageService.currentLanguage),
                                    style: GoogleFonts.cairo(
                                      fontSize: isMobile ? 10.0 : (isTablet ? 11.0 : 12.0),
                                      fontWeight: FontWeight.w600,
                                      color: AppColors.success,
                    ...
                    ] else if (booking['status'] == 'completed' && booking['hasRating'] == true) ...[
  ...
  void _showRatingDialog(int index, Map<String, dynamic> booking, LanguageService languageService) {
    double rating = 0.0;
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                '${AppStrings.getString('rateClientFor', languageService.currentLanguage)} ${booking['clientName']}',
                style: GoogleFonts.cairo(
                  fontSize: 14,
                  color: AppColors.grey,
                ),
                ...
                children: List.generate(5, (starIndex) {
                  return GestureDetector(
                    ...
                    child: Icon(
                      ...
                      size: 32,
                      color: starIndex < rating ? AppColors.warning : AppColors.grey,
                    ),
                  );
                }),
              ),
              SizedBox(height: 16),
              Text(
                '${rating.toInt()}/5 ${AppStrings.getString('stars', languageService.currentLanguage)}',
                style: GoogleFonts.cairo(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                  color: AppColors.primary,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: AppStrings.getString('addComment', languageService.currentLanguage),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: rating > 0 ? () {
                _submitRating(index, rating, commentController.text, languageService);
              ...
              child: Text(
                AppStrings.getString('submit', languageService.currentLanguage),
  ...
  void _submitRating(int index, double rating, String comment, LanguageService languageService) {
    // Update the booking with rating information
    setState(() {
      _bookings[index]['rating'] = rating;
      _bookings[index]['comment'] = comment;
      _bookings[index]['hasRating'] = true;
    });
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          AppStrings.getString('ratingSubmittedSuccessfully', languageService.currentLanguage),
        ),
        backgroundColor: AppColors.success,
      ),
    );
