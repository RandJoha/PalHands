...
import 'features/services/presentation/pages/service_search_screen.dart';
import 'shared/widgets/payment_test_page.dart';
import 'shared/widgets/simple_payment_test.dart';
import 'shared/widgets/basic_payment_test.dart';
import 'shared/widgets/quick_payment_test_access.dart';
import 'shared/widgets/debug_payment_test.dart';
import 'shared/widgets/services_integration_test.dart';
...
void main() async {
  ...
  // Enable backend integration for service persistence
          ...
          providers: [
            ...
            ChangeNotifierProvider(
              create: (context) {
                ...
                // Set the AuthService instance for ProviderService
            ...
            elevatedButtonTheme: ElevatedButtonThemeData(
              style: ElevatedButton.styleFrom(
                ...
                routes: {
                  ...
                  '/services': (context) => const ServiceSearchScreen(),
                  '/signup': (context) {
                    final args = ModalRoute.of(context)?.settings.arguments as Map<String, dynamic>?;
                    return SignupScreen(arguments: args);
                  },
                  '/provider': (context) => const ProviderDashboardScreen(),
                  '/payment-test': (context) => const PaymentTestPage(),
                  '/simple-payment-test': (context) => const SimplePaymentTest(),
                  '/basic-payment-test': (context) => const BasicPaymentTest(),
                  '/quick-payment-test': (context) => const QuickPaymentTestAccess(),
                  '/debug-payment-test': (context) => const DebugPaymentTest(),
                  '/services-integration-test': (context) => const ServicesIntegrationTest(),
                },
                ...
                onGenerateRoute: (settings) {
                  ...
                  switch (uri.path) {
                    ...
                    case '/services':
                      return MaterialPageRoute(builder: (_) => const ServiceSearchScreen(), settings: settings);
                    case '/signup':
                      return MaterialPageRoute(
                        builder: (_) => SignupScreen(arguments: settings.arguments as Map<String, dynamic>?),
                        settings: settings,
                      );
                    case '/provider':
                      return MaterialPageRoute(builder: (_) => const ProviderDashboardScreen(), settings: settings);
                    case '/payment-test':
                      return MaterialPageRoute(builder: (_) => const PaymentTestPage(), settings: settings);
                    case '/simple-payment-test':
                      return MaterialPageRoute(builder: (_) => const SimplePaymentTest(), settings: settings);
                    case '/basic-payment-test':
                      return MaterialPageRoute(builder: (_) => const BasicPaymentTest(), settings: settings);
                    case '/quick-payment-test':
                      return MaterialPageRoute(builder: (_) => const QuickPaymentTestAccess(), settings: settings);
                    case '/debug-payment-test':
                      return MaterialPageRoute(builder: (_) => const DebugPaymentTest(), settings: settings);
                    case '/services-integration-test':
                      return MaterialPageRoute(builder: (_) => const ServicesIntegrationTest(), settings: settings);
                  }
                  // Unknown route -> home
                  return MaterialPageRoute(builder: (_) => const AuthWrapper(), settings: settings);
                },
