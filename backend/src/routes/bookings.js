...
router.post('/:id/rate-client', auth, checkRole(['provider']), rateClientValidator, bookingsController.rateClient);
...
router.post('/:id/rate-provider', auth, checkRole(['client', 'user']), rateProviderValidator, bookingsController.rateProvider);
